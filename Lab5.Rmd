...
```{r, cache = TRUE}
graphics.off() #Found on StackExchange because of error
par("mar") #Found on StackExchange because of error
par(mar=c(1,1,1,1)) #Found on StackExchange because of error
